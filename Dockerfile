...
RUN mkdir -p /opt/janus/share/janus/certs
COPY certs/mycert.pem /opt/janus/share/janus/certs/mycert.pem
COPY certs/mycert.key /opt/janus/share/janus/certs/mycert.key
